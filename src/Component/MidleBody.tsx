...
const MiddleBody = () => {
    ...
    <Container className={classes.container} maxWidth="xl">
        <Typography className={classes.headerText} variant="h4" align="center">Let Them Knew Why you're the Best</Typography>
        <Typography variant="subtitle1" align="center" paragraph>We're building on of the best theme, landing pages ever made history </Typography>
